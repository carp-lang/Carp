...
Right now I've only built this on OSX 10.10. More platforms are coming though, the project is written in C99.
There are a few dependencies that has to be installed:
 * libffi
 * glfw3
 * rlwrap
