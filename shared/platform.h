...
// According to http://linux.die.net/man/3/dlopen the symbols RTLD_DEFAULT and RTLD_NEXT
// are defined by <dlfcn.h> only when _GNU_SOURCE was defined before including it.
// On Ubuntu 14.04 this definition fixed the missing symbol though:
#ifndef __USE_GNU
#define __USE_GNU
#endif
